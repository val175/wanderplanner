import{r as s,j as t}from"./index-D9fetyDh.js";function i({leftSlot:a,rightSlot:d}){const[l,o]=s.useState(!1),n=s.useRef(null);return s.useEffect(()=>{var m;const e=(m=n.current)==null?void 0:m.closest('[role="tabpanel"]');if(!e)return;const r=()=>{o(e.scrollTop>10)};return r(),e.addEventListener("scroll",r),()=>e.removeEventListener("scroll",r)},[]),t.jsxs("div",{ref:n,className:`
      flex flex-col gap-2
