import{r as o,j as b}from"./index-CDY2j4Rc.js";function w({value:e,displayValue:d,onSave:l,tag:m="span",className:g="",inputClassName:E="",placeholder:u="Click to edit...",multiline:n=!1,readOnly:x=!1}){const[c,f]=o.useState(!1),[s,r]=o.useState(e),i=o.useRef(null);o.useEffect(()=>{var t,a;c&&i.current&&(i.current.focus(),(a=(t=i.current).select)==null||a.call(t))},[c]),o.useEffect(()=>{r(e)},[e]);const p=()=>{f(!1);const t=(s==null?void 0:s.trim())??"";if(!t){r(e);return}t!==e&&l(t)},h=t=>{t.key==="Enter"&&!n&&(t.preventDefault(),p()),t.key==="Escape"&&(r(e),f(!1))};if(c){const t=n?"textarea":"input";return b.jsx(t,{ref:i,value:s,onChange:a=>r(a.target.value),onBlur:p,onKeyDown:h,placeholder:u,className:`
